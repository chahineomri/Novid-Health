...
if (isset($_POST['reference']) && isset($_POST['description']) && isset($_POST['date_debut']) && isset($_POST['date_fin'])) {
    ...
    $benevoleController->addBenevole($benevole);
    header('Location:index.php');
}
?>
<?php include_once '../header.php'; ?>
    <h3><i class="fa fa-angle-right"></i>Ajouter nouvelle bénévolat</h3>
    <form class="form-horizontal style-form" action="" method="POST">
        ...
        <div class="form-group">
            ...
            <div class="col-sm-10">
                <textarea class="form-control" name="description" placeholder="Description" rows="5" data-msg="Please write something for us"></textarea>
            </div>
        </div>
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-xs-11">
                <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" name="date_debut" value="" id="dateDeb">
        ...
        <div class="form-group">
            ...
            <div class="col-md-3 col-xs-11">
                <input class="form-control form-control-inline input-medium default-date-picker" size="16" type="date" name="date_fin" value="" id="dateFin">
                <span class="help-block">Select date</span>
            </div>
        </div>
        <div class="form-group">
